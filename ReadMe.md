...
You can download any directory(folder) in .zip format by copying the link of that directory and pasting it on [DownGit](https://minhaskamal.github.io/DownGit/#/home){:target="_blank"}
